...
Settled threads keep showing and sorting by their last user message. Settling an old thread does
not make it appear recent. Threads without a user message use their creation time.
