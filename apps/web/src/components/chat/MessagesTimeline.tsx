...
export const MessagesTimeline = memo(function MessagesTimeline({
  ...
  const handleScroll = useCallback(() => {
    ...
    if (isAtEnd) {
      clearTimelineScrollBookmark(listIdentityKey);
    } else if (isAtEnd === false) {
      captureTimelineScrollBookmark(listIdentityKey, rows, state, listHeaderSizeRef.current);
    }
      ...
      <TimelineRowActivityCtx value={activityState}>
        ...
        >
          ...
          <LegendList<MessagesTimelineRow>
            ...
            initialScrollAtEnd={citationRequest === null && initialScrollPosition === null}
            {...(citationRequest === null && initialScrollPosition
              ? { initialScrollIndex: initialScrollPosition }
              : {})}
