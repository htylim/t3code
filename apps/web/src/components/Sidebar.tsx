...
// Settled rows keep the conversation's age rather than jumping to the top
// when lifecycle metadata changes.
...
export default function Sidebar() {
  ...
  useEffect(
    () =>
      subscribeSidebarProjectFilterScope((update) => {
        const current = useUiStateStore.getState().sidebarProjectScopeKey;
        setProjectScopeKey(typeof update === "function" ? update(current) : update);
      }),
    [setProjectScopeKey],
  );
