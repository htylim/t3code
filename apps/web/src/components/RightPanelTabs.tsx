      ...
      <TooltipTrigger
        render={
          <button
            ...
            onDoubleClick={props.surface.kind === "device" ? props.onRenameDevice : undefined}
          >
                ...
                >
                  ...
                  {renamingDevice === surface.id ? (
                    ...
                    <SurfaceTitleButton
                      ...
                      onRenameDevice={
                        props.onRenameDevice ? () => setRenamingDevice(surface.id) : undefined
                      }
                    />
                  )}
                </div>
      ...
      <div className="flex min-h-0 flex-1 flex-col" data-right-panel-surface-content>
        {props.activeSurfaceId === null ? (
          <RightPanelEmptyState
            {...(props.onAddChat ? { onAddChat: props.onAddChat } : {})}
