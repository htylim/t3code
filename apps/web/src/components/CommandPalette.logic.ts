...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "project-switch";
}
...
export type CommandPaletteUiAction =
  ...
  | { readonly _tag: "OpenProjectSwitch" }
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenProjectSwitch":
      return { open: true, mode: "command", openIntent: { kind: "project-switch" } };
