...
// Scans the read model's recent activities plus pending async questions.
// Blocking requests cannot accumulate later activity until resolved, while
// async questions stay actionable as the agent continues working.
